...
class MeshConvNet(nn.Module):
    """Network for learning a global shape descriptor (classification) without pooling"""
    def __init__(self, norm_layer, nf0, conv_res, nclasses, input_res, pool_res, fc_n, *args, nresblocks=3):
        ...
        # Adjust the global pooling layer if necessary
        self.gp = torch.nn.AdaptiveAvgPool1d(1)  # Example: Adaptive Pooling
